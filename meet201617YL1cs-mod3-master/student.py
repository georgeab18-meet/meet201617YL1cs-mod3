...
class Student:
    ...
    def get_days_to_birthday(self):
        ...
        if self.birthdate_month < cur_date[1]:
            b_date = time.mktime((cur_date[0]+1,self.birthdate_month,self.birthdate_day,0,0,0,0,0,0))
        elif self.birthdate_month == cur_date[1]:
            if self.birthdate_day < cur_date[2]:
                b_date = time.mktime((cur_date[0]+1,self.birthdate_month,self.birthdate_day,0,0,0,0,0,0))
            elif self.birthdate_day < cur_date[2]:
        ...
        return (b_date-time.mktime(cur_date))/86400
